...
function ViewOrdDetails() {
  ...
  return (
    <div className='w-full mx-auto'>
      <div id='customer_details' className='p-2 min-h-48'>
        <h2 className="text-xl font-bold m-2 text-slate-600">Customer Details</h2>
        {billData && 
        <div className='px-4 w-full'>
          <Row>
            <Col md={6} className='p-1'>
              <label className='block text-gray-700 font-bold'>Order No:</label>
              <input
                type="text"
                className="font-bold text-slate-500 p-1"
                value={billData?.OA_NO}
                disabled
              />
            </Col>
            <Col md={6} className='p-1'>
              ...
              <input
                type="text"
                className="font-bold text-slate-500 p-1"
                value={formatFirestoreTimestamp(billData?.OA_DATE)}
                disabled
              />
            </Col>
            <Col md={6} className='p-1'>
              <label className='block text-gray-700 font-bold'>Advance Amt:</label>
              <input
                type="text"
                className="font-bold text-slate-500 p-1"
                value={billData?.ADV_AMT}
                disabled
              />
            </Col>
            <Col md={6} className='p-1'>
