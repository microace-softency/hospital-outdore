...
function BillUpdatePage() {
  ...
  const handlePaymentReceived = async () => {
    ...
    deleteMultipleDocs(myCollection(collections.BILL), 'BILL_NO', state.bill.BILL_NO)
    deleteMultipleDocs(myCollection(collections.BILLTERM), 'BILL_NO', state.bill.BILL_NO)
    deleteMultipleDocs(myCollection(collections.BILLDET), 'BILL_NO', state.bill.BILL_NO)
      .then((res) => {
        multiEntry(entries);
