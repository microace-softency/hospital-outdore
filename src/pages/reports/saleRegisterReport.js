...
function SaleRegisterReport() {
  ...
  const billCollection = myCollection(collections.BILL)
  const billDetCollection = myCollection(collections.BILLDET)
  ...
  return (
    <div className="container">
      <h4 className='text-teal-800'>Sale Invoice Register </h4>
