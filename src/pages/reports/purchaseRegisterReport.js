...
function PurchaseRegisterReport() {
  ...
  const billCollection = myCollection(collections.BILLIN)
  const billDetCollection = myCollection(collections.BLLINDET)
  const FDATE = 'BILL_DATE'
  const FNUMBER = 'BILL_NO'
  ...
  return (
    <div className="container">
      <h4 className='text-teal-800'>Purchase Invoice Register </h4>
