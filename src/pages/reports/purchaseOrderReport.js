...
function PurchaseOrderReport() {
  ...
  const collection1 = myCollection(collections.PORDER)
  const collection2 = myCollection(collections.PORDERDET)
  ...
  return (
    <div className="container">
      <h4 className='text-teal-800'>Purchase Order Register </h4>
