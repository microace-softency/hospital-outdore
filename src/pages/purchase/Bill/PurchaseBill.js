...
function PurchaseBill() {
  ...
  const collectionName = myCollection(collections.BILLIN)
...
//   }
  ...
  const handleDelete = (id) => {
    deleteMultipleDocs(myCollection(collections.BILLIN), 'BILL_NO', id)
    deleteMultipleDocs(myCollection(collections.BLLINDET), 'BILL_NO', id)
  ...
  return (
    <div className='container p-2 '>
      ...
      <Modal className="" show={showDeleteModal} onHide={cancelDelete}>
        ...
        <Button className='mb-2 drop-shadow' onClick={() => navigate('/purchase/bill/add')}> Add </Button>
      {isLoading && !data[0] &&
